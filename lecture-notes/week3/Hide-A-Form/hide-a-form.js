angular.module("hidden-form", ["ngRoute"])
    .controller("edit",
     editController)
     .controller("form", 
    formController)
...
function Router ($routeProvider){
   ...
   $routeProvider
        .when("/profile", {
            ...
            controller: "form as fCtrl"
        })
        .when("/thoughts", {
            templateUrl: "templates/thoughts.html",
            controller: "edit as eCtrl"
        });
}
///////////////////////////////////////////////////////////////////////////////////////////////
...
function editController () {
    ...
    function formController () {
        ...
        fCtrl.nameText = "Rob Gordon";

        fCtrl.bioText = "Scenester DIY shoreditch deep v tote bag, street art paleo. Before they sold out blog salvia listicle, beard keytar in art party est readymade kale chips +1 crucifix id try-hard.Sustainable mixtape fingerstache, pitchfork banjo meditation hashtag artisan kitsch. Sustainable 3 wolf moon helvetica food truck art party, tote bag celiac. Dreamcatcher man bun YOLO butcher, literally banjo jean shorts twee next level drinking vinegar squid yuccie PBR&B art party brooklyn."

        fCtrl.booksText = "Hammock 8-bit lo-fi ullamco kombucha craft beer. Gentrify tempor wayfarers roof party pop-up. Ugh everyday carry semiotics tattooed nisi actually. Yuccie chia four dollar toast sint photo booth. Street art meggings synth, knausgaard fingerstache tofu lo-fi. Ennui letterpress flexitarian polaroid";

        fCtrl.librariesText = "tote bag celiac. Dreamcatcher man bun YOLO butcher, literally banjo jean shorts"
    
        fCtrl.myVar1 = false;

        console.log('hello');
        fCtrl.updateProfile = function(){
        fCtrl.myVar1 = !fCtrl.myVar1;
        console.log('hi');
